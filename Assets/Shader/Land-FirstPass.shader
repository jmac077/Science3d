Shader "Erosion/LandTerrainShader" {
	Properties {
	...
	SubShader {
		...
		#include "ErosionTerrainSplatmapCommon.cginc"
	...
	Dependency "AddPassShader" = "Hidden/Erosion/Splatmap/Land-AddPass"
	Dependency "BaseMapShader" = "Hidden/Erosion/Splatmap/Land-Base"
